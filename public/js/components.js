  ...
  <div class="nav-inner">
    ...
    <a href="/" class="nav-logo">
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Perfect Flower Petals (8-fold symmetry) -->
        ...
        <ellipse cx="20" cy="14" rx="3.5" ry="7" fill="none" stroke="var(--accent)" stroke-width="1.1" transform="rotate(135 20 20)"/>
        <ellipse cx="20" cy="14" rx="3.5" ry="7" fill="none" stroke="var(--accent)" stroke-width="1.1" transform="rotate(180 20 20)"/>
        <ellipse cx="20" cy="14" rx="3.5" ry="7" fill="none" stroke="var(--accent)" stroke-width="1.1" transform="rotate(225 20 20)"/>
        <ellipse cx="20" cy="14" rx="3.5" ry="7" fill="none" stroke="var(--accent)" stroke-width="1.1" transform="rotate(270 20 20)"/>
        <ellipse cx="20" cy="14" rx="3.5" ry="7" fill="none" stroke="var(--accent)" stroke-width="1.1" transform="rotate(315 20 20)"/>
        <!-- Center dot -->
    ...
    <div class="nav-right">
      ...
      <a href="/contact" class="btn btn-primary btn-sm nav-book-btn">Book a Class</a>
      <!-- Hamburger -->
