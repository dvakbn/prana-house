-- ═══════════════════════════════════════════════════════════════
-- PRANA HOUSE - Clean Data Insert (No Errors)
...
-- Insert Program (Guided Meditation)
...
('Guided Meditation Program', 'guided-meditation', 'Meditation', '🧘',
...
SELECT 'Classes' as table_name, COUNT(*) as inserted FROM classes
UNION ALL
...
UNION ALL
SELECT 'READY' as table_name, 'Website is now fully populated!' as inserted;
